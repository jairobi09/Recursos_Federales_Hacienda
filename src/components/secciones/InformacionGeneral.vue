  ...
  <main class="flex flex-col w-full items-center">
    ...
    <div class="w-full grid grid-cols-2 gap-4 mt-6">
      <section
        ...
        <h4 class="text-[#04878c]">Material de apoyo</h4>
        <div class="grid grid-cols-2 gap-4" v-if="infoGeneral?.presentacion.guias">
          <div class="col-span-full lg:col-span-1" v-for="guia in infoGeneral?.presentacion.guias" :key="guia.id">
            <CardGuia :guia="guia" />
          </div>
        </div>
      </section>
      <section class="p-6 col-start-1 col-span-2 lg:col-start-2 lg:col-span-1 flex flex-col gap-4">
        <div class="flex-1 flex flex-col gap-2">
          ...
          <span class="text-xs">El <strong> módulo Evaluaciones</strong> se encuentra en construcción. Las evaluaciones a Fondos de
        ...
        <div class="grid grid-cols-2 gap-4" v-if="infoGeneral?.recursos.videos">
          <div class="col-span-full lg:col-span-1" v-for="video in infoGeneral?.recursos.videos" :key="video.url">
