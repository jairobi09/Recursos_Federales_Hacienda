...
<template>
    <div class="rounded-3xl card-video shadow-xl border border-[#e2e8f0] hover:border-[#04878c]">
        <div class="contenedor-video rounded-lg">
            <FrameVideoYT :url="video.url"/>
        </div>
        <h4 class="flex-1 text-[#04878c]" v-if="video.titulo" v-html="video.titulo"></h4>
